...
\begin{align*}
&\abs{L(\lambda_t)_i} = \abs{c^1_i - c^0_i} = 
\end{align*}
...
\Leftrightarrow &\frac{1}{T} \sum_{t=1}^T U(h_t,\lambda_t) \le U(h,\bar{\lambda}) + \frac{(2M + B)\sqrt{n}}{\sqrt{T}}
\end{align*}
...
\Leftrightarrow &\frac{1}{T} \sum_{t=1}^T U(h_t,\lambda_t) \ge \E_{h \sim D} U(h,\lambda) - B(4\gamma_1 + \gamma_2)
\end{align*}
\end{proof}
\section{Conclusion}
