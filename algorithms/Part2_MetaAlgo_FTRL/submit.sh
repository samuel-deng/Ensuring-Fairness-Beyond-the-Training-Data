...
python main.py --solver ECOS --num_cores 22 --T_inner 250 --T 1 --eta_inner 0.1
python main.py --solver ECOS --num_cores 22 --T_inner 500 --T 1 --eta_inner 0.1
python main.py --solver ECOS --num_cores 22 --T_inner 1000 --T 1 --eta_inner 0.1
