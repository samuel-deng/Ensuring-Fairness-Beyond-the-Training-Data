...
class BayesianOracle:
    ...
    Returns a uniform distribution over T_inner classifiers. 
    ...
    def execute_oracle(self):
        ...
        # Form Ensemble Classifier and return
        majority_vote_hypothesis = VotingClassifier(hypotheses)
        return majority_vote_hypothesis
